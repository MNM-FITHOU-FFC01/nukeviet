...
--
-- Host: localhost
-- Generation Time: Mar 24, 2022 at 07:44 AM
...
(1, 'ckeditor', 1, 'adobe,archives,audio,documents,flash,images,real,video|1|1|1', 'Administrator', 'siteinfo', '', 0, 0, 0, '', '', 0, '', '', '49383692798f6c0f1ec7985496e3ed2d', 1648098576, '::1', 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/99.0.4844.51 Safari/537.36');
...
(1, 'siteinfo', 'mod_siteinfo', 1, 1, 1, 1, '4a7da4176d4c4122054cc6def2ea0bc9'),
(2, 'authors', 'mod_authors', 2, 1, 1, 1, '37c7164eac8c6e76ae0d70941153253f'),
(3, 'settings', 'mod_settings', 3, 1, 1, 0, '80df64177f68fab7b679471e643d786c'),
(4, 'database', 'mod_database', 4, 1, 0, 0, 'e7b4ae09d231153d8b2aa4682dc8417d'),
(5, 'webtools', 'mod_webtools', 5, 1, 1, 0, '388388f721451174c616b61a350a2063'),
(6, 'seotools', 'mod_seotools', 6, 1, 1, 0, '548b4230c6de3d1614fb2cea9e51db20'),
(7, 'language', 'mod_language', 7, 1, 1, 0, '7436b3ed1f65ad633602f4ac6a437311'),
(8, 'modules', 'mod_modules', 8, 1, 1, 0, '2c2ec2fdae7e0769e8fe381107b9ea27'),
(9, 'themes', 'mod_themes', 9, 1, 1, 0, '373411b7604888a4f67b67eac7025759'),
(10, 'extensions', 'mod_extensions', 10, 1, 0, 0, 'a65602d9d24dac872471df9cfa61f195'),
(11, 'upload', 'mod_upload', 11, 1, 1, 1, 'fe4908a293bab304e360420d3ad36d64'),
(12, 'zalo', 'mod_zalo', 12, 1, 0, 0, 'de8274d9d09608115a24468da088b843');
...
(1, 'Mid-page advertisement', 1, 1, 'webnhanh.jpg', 'png', 'image/jpeg', 575, 72, '', '', 'http://webnhanh.vn', '_blank', '', 1648084714, 1648084714, 0, 0, 1, 1),
(2, 'Left-column advertisement', 2, 1, 'vinades.jpg', 'jpg', 'image/jpeg', 212, 400, '', '', 'http://vinades.vn', '_blank', '', 1648084714, 1648084714, 0, 0, 1, 2);
...
('sys', 'global', 'timestamp', '1648098561'),
...
('vi', 'global', 'site_logo', ''),
('vi', 'global', 'site_banner', 'uploads/hinh-nen-coder-3.jpg'),
('vi', 'global', 'site_favicon', ''),
('vi', 'global', 'site_description', 'Chia sẻ thành công, kết nối đam mê 12'),
...
('vi', 'global', 'cronjobs_next_time', '1648104248'),
...
('sys', 'global', 'session_prefix', 'nv4s_y274Xv'),
...
('sys', 'global', 'ftp_user_pass', 'OTixDlpQElnmOwEzhkHARw,,'),
('sys', 'global', 'ftp_path', '/'),
...
('c_time', 'start', 0, 0, 0),
('c_time', 'last', 0, 1648103638, 0),
('total', 'hits', 1648103638, 10, 10),
('year', '2022', 1648103638, 10, 10),
('year', '2023', 0, 0, 0),
('year', '2024', 0, 0, 0),
('year', '2025', 0, 0, 0),
('year', '2026', 0, 0, 0),
...
('dayofweek', 'Thursday', 1648103638, 10, 10),
...
('hour', '06', 0, 0, 0),
('hour', '07', 0, 0, 0),
('hour', '08', 1648086701, 2, 2),
('hour', '09', 1648088843, 1, 1),
('hour', '10', 1648093422, 2, 2),
('hour', '11', 1648097860, 2, 2),
('hour', '12', 1648099998, 1, 1),
('hour', '13', 1648103638, 2, 2),
('hour', '14', 0, 0, 0),
('hour', '15', 0, 0, 0),
('hour', '16', 0, 0, 0),
('hour', '17', 0, 0, 0),
...
('browser', 'ipod', 0, 0, 0),
('browser', 'ipad', 0, 0, 0),
('browser', 'chrome', 1648103638, 10, 10),
('browser', 'cococ', 0, 0, 0),
...
(1, 1648084714, 5, 0, 'online_expired_del.php', 'cron_online_expired_del', '', 0, 1, 1, 1648103948, 1, 'Xóa các dòng ghi trạng thái online đã cũ trong CSDL'),
(2, 1648084714, 1440, 0, 'dump_autobackup.php', 'cron_dump_autobackup', '', 0, 1, 1, 1648084744, 1, 'Tự động lưu CSDL'),
(3, 1648084714, 60, 0, 'temp_download_destroy.php', 'cron_auto_del_temp_download', '', 0, 1, 1, 1648103647, 1, 'Xóa các file tạm trong thư mục tmp'),
(4, 1648084714, 30, 0, 'ip_logs_destroy.php', 'cron_del_ip_logs', '', 0, 1, 1, 1648102359, 1, 'Xóa IP log files, Xóa các file nhật ký truy cập'),
(5, 1648084714, 1440, 0, 'error_log_destroy.php', 'cron_auto_del_error_log', '', 0, 1, 1, 1648084744, 1, 'Xóa các file error_log quá hạn'),
(6, 1648084714, 360, 0, 'error_log_sendmail.php', 'cron_auto_sendmail_error_log', '', 0, 1, 0, 0, 0, 'Gửi email các thông báo lỗi cho admin'),
(7, 1648084714, 60, 0, 'ref_expired_del.php', 'cron_ref_expired_del', '', 0, 1, 1, 1648103647, 1, 'Xóa các referer quá hạn'),
(8, 1648084714, 60, 0, 'check_version.php', 'cron_auto_check_version', '', 0, 1, 1, 1648103647, 1, 'Kiểm tra phiên bản NukeViet'),
(9, 1648084714, 1440, 0, 'notification_autodel.php', 'cron_notification_autodel', '', 0, 1, 1, 1648084744, 1, 'Xóa thông báo cũ');
...
(1, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:::1', '', 0, 1648084750),
(2, 'vi', 'upload', 'Upload file', 'uploads/hinh-nen-coder-3.jpg', '', 1, 1648084927),
(3, 'vi', 'themes', 'Thiết lập giao diện theme: \"olp\"', '', '', 1, 1648085997),
(4, 'vi', 'themes', 'Kích hoạt theme: \"olp\"', '', '', 1, 1648086001),
(5, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1648086371),
(6, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1648086559),
(7, 'vi', 'themes', 'Thêm block', 'Name : global metismenu', '', 1, 1648086601),
(8, 'vi', 'themes', 'Thêm block', 'Name : global banner detail', '', 1, 1648087508),
(9, 'vi', 'themes', 'Thêm block', 'Name : global page list', '', 1, 1648087673),
(10, 'vi', 'themes', 'Sửa block', 'Name : global page list', '', 1, 1648087682),
(11, 'vi', 'themes', 'Thêm block', 'Name : global logotitle', '', 1, 1648088012),
(12, 'vi', 'themes', 'Thêm block', 'Name : global footer bottom', '', 1, 1648088465),
(13, 'vi', 'themes', 'Sửa block', 'Name : global footer bottom', '', 1, 1648089442),
(14, 'vi', 'themes', 'Sửa block', 'Name : global footer bottom', '', 1, 1648089630),
(15, 'vi', 'news', 'Thêm bài viết', 'Tieu de', '', 1, 1648093406),
(16, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:::1', '', 0, 1648094404),
(17, 'vi', 'upload', 'Upload file', 'uploads/hinh-nen-coder-3.jpg', '', 1, 1648094484),
(18, 'vi', 'themes', 'Sửa block', 'Name : global footer bottom', '', 1, 1648096310),
(19, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1648096914),
(20, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:::1', '', 0, 1648096937),
(21, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1648096948),
(22, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:::1', '', 0, 1648098404),
(23, 'vi', 'menu', 'Add row menu', 'Row menu id: 23 of Menu id: 1', '', 1, 1648098464),
(24, 'vi', 'webtools', 'Dọn dẹp hệ thống', 'clearcache, clearfiletemp, clearerrorlogs, clearip_logs', '', 1, 1648098561),
(25, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:::1', '', 0, 1648098576),
(26, 'vi', 'themes', 'Sửa block', 'Name : global banner detail', '', 1, 1648098592),
(27, 'vi', 'themes', 'Sửa block', 'Name : global banner detail', '', 1, 1648098599),
(28, 'vi', 'upload', 'Upload file', 'uploads/hinh-nen-coder-3.jpg', '', 1, 1648098639),
(29, 'vi', 'modules', 'Thiết lập module mới tudien', '', '', 1, 1648098681),
(30, 'vi', 'modules', 'Sửa module &ldquo;tudien&rdquo;', '', '', 1, 1648098686),
(31, 'vi', 'themes', 'Sửa block', 'Name : global logotitle', '', 1, 1648098871),
(32, 'vi', 'themes', 'Thêm block', 'Name : global metismenu', '', 1, 1648098905),
(33, 'vi', 'themes', 'Thêm block', 'Name : global metismenu', '', 1, 1648098939),
(34, 'vi', 'themes', 'Sửa block', 'Name : global banner detail', '', 1, 1648098966),
(35, 'vi', 'themes', 'Sửa block', 'Name : global page list', '', 1, 1648098974),
(36, 'vi', 'themes', 'Sửa block', 'Name : global footer bottom', '', 1, 1648098983),
(37, 'vi', 'news', 'Đăng bài viết', 'tesstsdfdasf | ::1 | admin', '', 0, 1648099569),
(38, 'vi', 'news', 'Xóa bài viêt', 'tesstsdfdasf', '', 1, 1648100328);
...
('a7e033f7871b8d5c1093a8b59d1ada06', 1, 'admin', 1648104189);
...
(0, 'module', 'about', 0, 0, 'page', 'about', '4.5.01 1636189200', 1648084714, 'VINADES <contact@vinades.vn>', ''),
(0, 'module', 'siteterms', 0, 0, 'page', 'siteterms', '4.5.01 1636189200', 1648084714, 'VINADES <contact@vinades.vn>', ''),
(19, 'module', 'banners', 1, 0, 'banners', 'banners', '4.5.01 1636189200', 1648084714, 'VINADES <contact@vinades.vn>', ''),
(20, 'module', 'contact', 0, 1, 'contact', 'contact', '4.5.01 1636189200', 1648084714, 'VINADES <contact@vinades.vn>', ''),
(1, 'module', 'news', 0, 1, 'news', 'news', '4.5.01 1636189200', 1648084714, 'VINADES <contact@vinades.vn>', ''),
(21, 'module', 'voting', 0, 0, 'voting', 'voting', '4.5.01 1636189200', 1648084714, 'VINADES <contact@vinades.vn>', ''),
(0, 'module', 'tudien', 0, 1, 'tudien', 'tudien', '4.5.01 1636189200', 1648098679, 'VINADES.,JSC <contact@vinades.vn>', ''),
(284, 'module', 'seek', 1, 0, 'seek', 'seek', '4.5.01 1636189200', 1648084714, 'VINADES <contact@vinades.vn>', ''),
(24, 'module', 'users', 1, 1, 'users', 'users', '4.5.01 1636189200', 1648084714, 'VINADES <contact@vinades.vn>', ''),
(27, 'module', 'statistics', 0, 0, 'statistics', 'statistics', '4.5.01 1636189200', 1648084714, 'VINADES <contact@vinades.vn>', ''),
(29, 'module', 'menu', 0, 0, 'menu', 'menu', '4.5.01 1636189200', 1648084714, 'VINADES <contact@vinades.vn>', ''),
(283, 'module', 'feeds', 1, 0, 'feeds', 'feeds', '4.5.01 1636189200', 1648084714, 'VINADES <contact@vinades.vn>', ''),
(282, 'module', 'page', 1, 1, 'page', 'page', '4.5.01 1636189200', 1648084714, 'VINADES <contact@vinades.vn>', ''),
(281, 'module', 'comment', 1, 0, 'comment', 'comment', '4.5.01 1636189200', 1648084714, 'VINADES <contact@vinades.vn>', ''),
(312, 'module', 'freecontent', 0, 1, 'freecontent', 'freecontent', '4.5.01 1636189200', 1648084714, 'VINADES <contact@vinades.vn>', ''),
(327, 'module', 'two-step-verification', 1, 0, 'two-step-verification', 'two_step_verification', '4.5.01 1636189200', 1648084714, 'VINADES <contact@vinades.vn>', ''),
(307, 'theme', 'default', 0, 0, 'default', 'default', '4.5.01 1636189200', 1648084714, 'VINADES <contact@vinades.vn>', ''),
(311, 'theme', 'mobile_default', 0, 0, 'mobile_default', 'mobile_default', '4.5.01 1636189200', 1648084714, 'VINADES <contact@vinades.vn>', '');
...
(0, '', 0, 3, 100, 150, 90),
(1, 'uploads', 1648098622, 0, 0, 0, 0),
(2, 'uploads/banners', 0, 0, 0, 0, 0),
(3, 'uploads/banners/files', 0, 0, 0, 0, 0),
(4, 'uploads/news', 1648100389, 0, 0, 0, 0),
(5, 'uploads/news/topics', 0, 0, 0, 0, 0),
(6, 'uploads/news/temp_pic', 0, 0, 0, 0, 0),
(7, 'uploads/news/source', 1648091210, 0, 0, 0, 0),
(8, 'uploads/comment', 0, 0, 0, 0, 0),
(9, 'uploads/siteterms', 0, 0, 0, 0, 0),
(10, 'uploads/page', 0, 0, 0, 0, 0),
(11, 'uploads/users', 0, 0, 0, 0, 0),
(12, 'uploads/users/groups', 0, 0, 0, 0, 0),
(13, 'uploads/menu', 0, 0, 0, 0, 0),
(14, 'uploads/freecontent', 0, 0, 0, 0, 0),
(15, 'uploads/contact', 0, 0, 0, 0, 0),
(16, 'uploads/about', 1648091489, 0, 0, 0, 0),
(18, 'uploads/news/2022_03', 1648094535, 0, 0, 0, 0),
(19, 'uploads/tudien', 0, 0, 0, 0, 0);
...
('hinh-nen-c...jpg', 'jpg', 'image', 219029, 'assets/hinh-nen-coder-3.jpg', 80, 46, '1500|844', 1, 1648098639, 1, 'hinh-nen-coder-3.jpg', 'Hinh nen coder 3'),
('hoc-viec-t...jpg', 'jpg', 'image', 167193, 'assets/news/hoc-viec-tai-cong-ty-vinades.jpg', 80, 63, '460|360', 1, 1648098135, 4, 'hoc-viec-tai-cong-ty-vinades.jpg', 'hoc viec tai cong ty vinades'),
('nukeviet-cms.jpg', 'jpg', 'image', 83489, 'assets/news/nukeviet-cms.jpg', 80, 55, '500|345', 1, 1648098135, 4, 'nukeviet-cms.jpg', 'nukeviet cms'),
('nangly.jpg', 'jpg', 'image', 34802, 'assets/news/nangly.jpg', 80, 53, '500|332', 1, 1648098135, 4, 'nangly.jpg', 'nangly'),
('chuc-mung-...jpg', 'jpg', 'image', 130708, 'assets/news/chuc-mung-nukeviet-thong-tu-20-bo-tttt.jpg', 80, 62, '461|360', 1, 1648098135, 4, 'chuc-mung-nukeviet-thong-tu-20-bo-tttt.jpg', 'chuc mung nukeviet thong tu 20 bo tttt'),
('nukeviet-n...jpg', 'jpg', 'image', 18611, 'assets/news/nukeviet-nhantaidatviet2011.jpg', 80, 54, '400|268', 1, 1648098135, 4, 'nukeviet-nhantaidatviet2011.jpg', 'nukeviet nhantaidatviet2011'),
('tap-huan-p...jpg', 'jpg', 'image', 132379, 'assets/news/tap-huan-pgd-ha-dong-2015.jpg', 80, 52, '460|295', 1, 1648098135, 4, 'tap-huan-pgd-ha-dong-2015.jpg', 'tap huan pgd ha dong 2015'),
('tuyendung-...jpg', 'jpg', 'image', 83783, 'assets/news/tuyendung-kythuat.jpg', 80, 80, '300|300', 1, 1648098135, 4, 'tuyendung-kythuat.jpg', 'tuyendung kythuat'),
('tuyen-dung...png', 'png', 'image', 118910, 'assets/news/tuyen-dung-nvkd.png', 80, 56, '400|279', 1, 1648098135, 4, 'tuyen-dung-nvkd.png', 'tuyen dung nvkd'),
('hoptac 6.jpg', 'jpg', 'image', 12871, 'uploads/news/hoptac 6.jpg', 80, 66, '382|314', 1, 1648098135, 4, 'hoptac 6.jpg', 'hoptac 6'),
('hoptac.jpg', 'jpg', 'image', 12871, 'assets/news/hoptac.jpg', 80, 66, '382|314', 1, 1648098135, 4, 'hoptac.jpg', 'hoptac'),
('nukevietvn.png', 'png', 'image', 81035, 'assets/about/nukevietvn.png', 80, 38, '1500|700', 1, 1648084653, 16, 'nukevietvn.png', 'nukevietvn'),
('nukevietcm...png', 'png', 'image', 13125, 'assets/about/nukevietcms_laco_180x57.png', 80, 26, '180|57', 1, 1648084653, 16, 'nukevietcms_laco_180x57.png', 'nukevietcms laco 180x57'),
('logo-nukev...png', 'png', 'image', 13223, 'assets/about/logo-nukeviet3-flag-180x75.png', 80, 34, '180|75', 1, 1648084653, 16, 'logo-nukeviet3-flag-180x75.png', 'logo nukeviet3 flag 180x75'),
('w.png', 'png', 'image', 12156, 'assets/about/w.png', 80, 40, '288|143', 1, 1648084653, 16, 'w.png', 'w'),
('nukevietcm...png', 'png', 'image', 11974, 'assets/about/nukevietcms-180x84.png', 80, 38, '180|84', 1, 1648084653, 16, 'nukevietcms-180x84.png', 'nukevietcms 180x84'),
('nukevietcms.png', 'png', 'image', 85684, 'assets/about/nukevietcms.png', 80, 38, '1500|700', 1, 1648084653, 16, 'nukevietcms.png', 'nukevietcms'),
('nukevietvn...png', 'png', 'image', 11586, 'assets/about/nukevietvn_180x84.png', 80, 38, '180|84', 1, 1648084653, 16, 'nukevietvn_180x84.png', 'nukevietvn 180x84'),
('nukevietcm...png', 'png', 'image', 13319, 'assets/about/nukevietcms_mu_noel_180x84.png', 80, 38, '180|84', 1, 1648084653, 16, 'nukevietcms_mu_noel_180x84.png', 'nukevietcms mu noel 180x84');
...
(1, 1, 'admin', '21232f297a57a5a743894a0e4a801fc3', '{SSHA512}17SnVBFaREWCGEg6LyoJc5ts7YgVuK4bda99d0s/PNQ/NcS9HeOMj2mSSStXfZcV2E2EoHb6EBz8kXf7RsT3RWVmMWU=', 'admin@gmail.com', 'admin', '', '', '', 0, '', 1648084742, 'admin', 'admin', '', 0, 1, '1,4', 1, 0, '', '', 1648084742, '', '', '', 0, 0, 0, '', -3, 'SYSTEM');
...
(1, 'Super-Admin', '', 0, '', '', 0, 0, 0, 1648084714, 0, 1, 1, 0, 1, 0, 'a:7:{s:17:\"access_groups_add\";i:1;s:17:\"access_groups_del\";i:1;s:12:\"access_addus\";i:0;s:14:\"access_waiting\";i:0;s:13:\"access_editus\";i:0;s:12:\"access_delus\";i:0;s:13:\"access_passus\";i:0;}'),
(2, 'General-Admin', '', 0, '', '', 0, 0, 0, 1648084714, 0, 2, 1, 0, 0, 0, 'a:7:{s:17:\"access_groups_add\";i:1;s:17:\"access_groups_del\";i:1;s:12:\"access_addus\";i:0;s:14:\"access_waiting\";i:0;s:13:\"access_editus\";i:0;s:12:\"access_delus\";i:0;s:13:\"access_passus\";i:0;}'),
(3, 'Module-Admin', '', 0, '', '', 0, 0, 0, 1648084714, 0, 3, 1, 0, 0, 0, 'a:7:{s:17:\"access_groups_add\";i:1;s:17:\"access_groups_del\";i:1;s:12:\"access_addus\";i:0;s:14:\"access_waiting\";i:0;s:13:\"access_editus\";i:0;s:12:\"access_delus\";i:0;s:13:\"access_passus\";i:0;}'),
(4, 'Users', '', 0, '', '', 0, 0, 0, 1648084714, 0, 4, 1, 0, 1, 0, 'a:7:{s:17:\"access_groups_add\";i:1;s:17:\"access_groups_del\";i:1;s:12:\"access_addus\";i:0;s:14:\"access_waiting\";i:0;s:13:\"access_editus\";i:0;s:12:\"access_delus\";i:0;s:13:\"access_passus\";i:0;}'),
(7, 'New-Users', '', 0, '', '', 0, 0, 0, 1648084714, 0, 5, 1, 0, 0, 0, 'a:7:{s:17:\"access_groups_add\";i:1;s:17:\"access_groups_del\";i:1;s:12:\"access_addus\";i:0;s:14:\"access_waiting\";i:0;s:13:\"access_editus\";i:0;s:12:\"access_delus\";i:0;s:13:\"access_passus\";i:0;}'),
(5, 'Guest', '', 0, '', '', 0, 0, 0, 1648084714, 0, 6, 1, 0, 0, 0, 'a:7:{s:17:\"access_groups_add\";i:1;s:17:\"access_groups_del\";i:1;s:12:\"access_addus\";i:0;s:14:\"access_waiting\";i:0;s:13:\"access_editus\";i:0;s:12:\"access_delus\";i:0;s:13:\"access_passus\";i:0;}'),
(6, 'All', '', 0, '', '', 0, 0, 0, 1648084714, 0, 7, 1, 0, 0, 0, 'a:7:{s:17:\"access_groups_add\";i:1;s:17:\"access_groups_del\";i:1;s:12:\"access_addus\";i:0;s:14:\"access_waiting\";i:0;s:13:\"access_editus\";i:0;s:12:\"access_delus\";i:0;s:13:\"access_passus\";i:0;}'),
(10, 'NukeViet-Fans', '', 2, '', '', 0, 0, 1, 1648084714, 0, 8, 1, 0, 0, 0, 'a:7:{s:17:\"access_groups_add\";i:1;s:17:\"access_groups_del\";i:1;s:12:\"access_addus\";i:0;s:14:\"access_waiting\";i:0;s:13:\"access_editus\";i:0;s:12:\"access_delus\";i:0;s:13:\"access_passus\";i:0;}'),
(11, 'NukeViet-Admins', '', 2, '', '', 0, 0, 0, 1648084714, 0, 9, 1, 0, 0, 0, 'a:7:{s:17:\"access_groups_add\";i:1;s:17:\"access_groups_del\";i:1;s:12:\"access_addus\";i:0;s:14:\"access_waiting\";i:0;s:13:\"access_editus\";i:0;s:12:\"access_delus\";i:0;s:13:\"access_passus\";i:0;}'),
(12, 'NukeViet-Programmers', '', 1, '', '', 0, 0, 0, 1648084714, 0, 10, 1, 0, 0, 0, 'a:7:{s:17:\"access_groups_add\";i:1;s:17:\"access_groups_del\";i:1;s:12:\"access_addus\";i:0;s:14:\"access_waiting\";i:0;s:13:\"access_editus\";i:0;s:12:\"access_delus\";i:0;s:13:\"access_passus\";i:0;}');
...
(1, 1, 1, 1, '0', 1648084742, 1648084742);
...
(53, 'olp', 'theme', 'global.banner_detail.php', 'global banner detail', '', 'no_title', '[BANNER]', 0, '1', 1, '6', 1, 1, 'a:5:{s:7:\"tieude1\";s:39:\"OLYMPIC TIN HỌC SINH VIÊN VIỆT NAM\";s:7:\"tieude2\";s:60:\"KỲ THI LẬP TRÌNH SINH VIÊN QUỐC TẾ ICPC ASIA HANOI\";s:7:\"tieude3\";s:22:\"ĐẠI HỌC FPT, từ\";s:4:\"indo\";s:13:\"22-25/03/2022\";s:5:\"image\";s:45:\"/nukeviet_new/assets/images/Hinhnencoder3.jpg\";}'),
(54, 'olp', 'about', 'global.about.php', 'global page list', '', 'no_title', '[MAIN]', 0, '1', 1, '6', 1, 1, ''),
(55, 'olp', 'theme', 'global.logotitle.php', 'global logotitle', '', 'no_title', '[LOGO]', 0, '1', 1, '6', 0, 1, ''),
(56, 'olp', 'theme', 'global.footer_bottom.php', 'global footer bottom', '', 'no_title', '[FOOTER_BOTTOM]', 0, '1', 1, '6', 1, 1, 'a:3:{s:8:\"tentrang\";s:81:\"HỘI TIN HỌC VIỆT NAM  (VIETNAM ASSOCIATON FOR INFORMATON PROCESSING - VAIP)\";s:4:\"mota\";s:79:\"Phụ trách: Ông Nguyễn Long,  Trưởng BTC OLP, Chủ tịch ICPC Vietnam\";s:14:\"thongtinlienhe\";s:156:\"Head office: 6th floor, 14 Tran Hung Dao Str., Hanoi, Vietnam ab - Tel: 84-24-38211725 - email office@vaip.vn - Web www.VAIP.vn http://congnghevadoisong.vn/\";}'),
(58, 'olp', 'menu', 'global.metismenu.php', 'global metismenu', '', 'no_title', '[MENU]', 0, '1', 1, '6', 1, 1, 'a:2:{s:6:\"menuid\";i:1;s:12:\"title_length\";i:0;}');
...
(2, 0, 1, 'Tin Tức', '/nukeviet/index.php?language=vi&nv=news', '', '', '', 2, 10, 0, '16,17,18,19,20,21,22,23', '6', 'news', '', 1, '', 0, 1),
(3, 0, 1, 'Thành viên', '/nukeviet/index.php?language=vi&nv=users', '', '', '', 3, 19, 0, '', '6', 'users', '', 1, '', 0, 1),
(4, 0, 1, 'Thống kê', '/nukeviet/index.php?language=vi&nv=statistics', '', '', '', 4, 20, 0, '', '2', 'statistics', '', 1, '', 0, 1),
(5, 0, 1, 'Thăm dò ý kiến', '/nukeviet/index.php?language=vi&nv=voting', '', '', '', 5, 21, 0, '', '6', 'voting', '', 1, '', 0, 1),
(6, 0, 1, 'Tìm kiếm', '/nukeviet/index.php?language=vi&nv=seek', '', '', '', 6, 22, 0, '', '6', 'seek', '', 1, '', 0, 1),
(7, 0, 1, 'Liên hệ', '/nukeviet/index.php?language=vi&nv=contact', '', '', '', 7, 23, 0, '', '6', 'contact', '', 1, '', 0, 1),
...
(23, 2, 1, 'Content', '/nukeviet/index.php?language=vi&nv=news&op=content', '', '', '', 8, 18, 1, '', '6', 'news', '', 1, '', 0, 1);
...
(66, 'main', 'main', 'Main', '', 'tudien', 1, 0, 1, '');
...
('about', 'page', 'about', 'about', 'page', 'Giới thiệu', '', '', 1648084714, 1, 1, '', '', '', '', '6', 1, 1, '', 1, 1),
('news', 'news', 'news', 'news', 'news', 'Tin Tức', '', '', 1648084714, 1, 1, '', '', '', '', '6', 2, 1, '', 1, 1),
('users', 'users', 'users', 'users', 'users', 'Thành viên', '', 'Tài khoản', 1648084714, 1, 1, '', '', '', '', '6', 3, 1, '', 0, 1),
('contact', 'contact', 'contact', 'contact', 'contact', 'Liên hệ', '', '', 1648084714, 1, 1, '', '', '', '', '6', 4, 1, '', 0, 1),
('statistics', 'statistics', 'statistics', 'statistics', 'statistics', 'Thống kê', '', '', 1648084714, 1, 1, '', '', '', 'online, statistics', '6', 5, 1, '', 0, 1),
('voting', 'voting', 'voting', 'voting', 'voting', 'Thăm dò ý kiến', '', '', 1648084714, 1, 1, '', '', '', '', '6', 6, 1, '', 1, 1),
('banners', 'banners', 'banners', 'banners', 'banners', 'Quảng cáo', '', '', 1648084714, 1, 1, '', '', '', '', '6', 7, 1, '', 0, 1),
('seek', 'seek', 'seek', 'seek', 'seek', 'Tìm kiếm', '', '', 1648084714, 1, 0, '', '', '', '', '6', 8, 1, '', 0, 1),
('menu', 'menu', 'menu', 'menu', 'menu', 'Menu Site', '', '', 1648084714, 0, 1, '', '', '', '', '6', 9, 1, '', 0, 1),
('feeds', 'feeds', 'feeds', 'feeds', 'feeds', 'RSS-feeds', '', '', 1648084714, 1, 1, '', '', '', '', '6', 10, 1, '', 0, 1),
('page', 'page', 'page', 'page', 'page', 'Page', '', '', 1648084714, 1, 1, '', '', '', '', '6', 11, 1, '', 1, 0),
('comment', 'comment', 'comment', 'comment', 'comment', 'Bình luận', '', 'Quản lý bình luận', 1648084714, 0, 1, '', '', '', '', '6', 12, 1, '', 0, 1),
('siteterms', 'page', 'siteterms', 'siteterms', 'page', 'Điều khoản sử dụng', '', '', 1648084714, 1, 1, '', '', '', '', '6', 13, 1, '', 1, 1),
('freecontent', 'freecontent', 'freecontent', 'freecontent', 'freecontent', 'Giới thiệu sản phẩm', '', '', 1648084714, 0, 1, '', '', '', '', '6', 14, 1, '', 0, 1),
('two-step-verification', 'two-step-verification', 'two_step_verification', 'two_step_verification', 'two-step-verification', 'Xác thực hai bước', '', '', 1648084714, 1, 0, '', '', '', '', '6', 15, 1, '', 0, 1),
('tudien', 'tudien', 'tudien', 'tudien', 'tudien', 'Từ điển', '', 'Từ điển', 1648098681, 1, 1, '', '', '', '', '6', 16, 1, '', 0, 0);
...
(16, 1, '1', 0, 1, '', 0, 1648093406, 1648093406, 1, 16, 1648093320, 0, 2, 'Tieu de', 'tieu-de', 'Tieu de', 'thuc-tap-sinh.jpg', 'Tieu de', 1, 1, '4', 1, 0, 1, 0, 0, 0, 0, '', 0);
...
(1, 1, 'admin', 'admin', '', '', 1648089683, 0, 1, 1);
...
--
-- Table structure for table `nv4_vi_tudien_loaitudien`
--

CREATE TABLE `nv4_vi_tudien_loaitudien` (
  `id` int(11) NOT NULL,
  `tenloaitd` varchar(250) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `nv4_vi_tudien_loaitudien`
--

INSERT INTO `nv4_vi_tudien_loaitudien` (`id`, `tenloaitd`) VALUES
(1648101929, 'Anh viêt'),
(1648103847, 'Thêm'),
(1648103902, 'Việt Anh');
...
--
-- Table structure for table `nv4_vi_tudien_tu`
--

CREATE TABLE `nv4_vi_tudien_tu` (
  `id` int(11) NOT NULL,
  `tentu` varchar(250) COLLATE utf8mb4_unicode_ci NOT NULL,
  `nghiatu` varchar(250) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_loaitu` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `nv4_vi_tudien_tu`
--

INSERT INTO `nv4_vi_tudien_tu` (`id`, `tentu`, `nghiatu`, `id_loaitu`) VALUES
(1648103436, 'Add', 'Thêm', 1648101929),
(1648103457, 'Emtertament', 'abc', 1648101929),
(1648103912, 'Giải trí', 'Entertament', 1648103902);
...
(2, 'Bạn biết gì về NukeViet 4?', '', 1, 0, 1, '6', 1648084714, 0, 1, 0),
(3, 'Lợi ích của phần mềm nguồn mở là gì?', '', 1, 0, 1, '6', 1648084714, 0, 1, 0);
...
--
-- Indexes for table `nv4_vi_tudien_loaitudien`
--
ALTER TABLE `nv4_vi_tudien_loaitudien`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `nv4_vi_tudien_tu`
--
ALTER TABLE `nv4_vi_tudien_tu`
  ADD PRIMARY KEY (`id`);
...
--
ALTER TABLE `nv4_vi_blocks_groups`
  MODIFY `bid` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=59;
